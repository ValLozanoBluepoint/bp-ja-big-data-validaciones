...
#    ./validate_kafka_flink_dr_kafka.sh                # crea + produce
#    ./validate_kafka_flink_dr_kafka.sh --cleanup <topic>  # borra
# =============================================================================
...
if [[ $FAIL -eq 0 ]] && $TOPIC_CREATED; then
  ...
  log "${CYAN}    ./validate_kafka_flink_dr_flink.sh --topic ${TEST_TOPIC}${NC}"
