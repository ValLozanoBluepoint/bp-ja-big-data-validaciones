...
## Corpus Check
- 6 files · ~129,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 330 nodes · 602 edges · 30 communities (27 shown, 3 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.84)
- Token cost: 60,029 input · 0 output

## Community Hubs (Navigation)
- Fallas Detectadas en Validacion Flink DR
- Integracion Flink-MinIO (Checkpoints S3)
- Plan de Implementacion Big Data
- Stack de Observabilidad y Kafka DR/Principal
- Script Validacion HAProxy-MinIO DR
- Script Validacion HAProxy-MinIO Principal
- Arquitectura PostgreSQL HA
- Mapa de Integraciones (Flink/Kafka/Iceberg/MinIO)
- Referencias del Skill Graphify
- Script Validacion Flink DR
- Script Validacion Flink Principal
- Script Validacion Kafka DR
- Script Validacion Kafka Principal
- Script Validacion Stack Obs DR
- Script Validacion Kafka-Flink DR (lado Flink)
- Script Validacion Stack Obs Principal
- Arquitectura Flink+MinIO+Gravitino (Diagrama)
- Script Validacion Kafka-Flink DR (lado Kafka)
- Script Validacion Kafka-Flink Principal (lado Flink)
- Script Validacion Flink-MinIO DR
- Script Validacion Kafka-Flink Principal (lado Kafka)
- Script Validacion Flink-MinIO Principal
- Script Validacion MinIO DR
- Script Validacion MinIO Principal
- Script Validacion Agentes Observabilidad
- Diagnostico Quorum Kafka Incompleto
- Guias de Preparacion Integracion Kafka-Flink-MinIO
- Script Validacion Node Exporter
- Checklist Validacion Observabilidad por DC
- Guia Validacion Cluster MinIO
...
9. `validate_kafka_dr.sh script` - 9 edges
10. `validate_kafka_principal.sh script` - 9 edges
...
### Community 0 - "Fallas Detectadas en Validacion Flink DR"
Cohesion: 0.11
...
### Community 1 - "Integracion Flink-MinIO (Checkpoints S3)"
Cohesion: 0.09
...
### Community 2 - "Plan de Implementacion Big Data"
Cohesion: 0.18
...
### Community 3 - "Stack de Observabilidad y Kafka DR/Principal"
Cohesion: 0.15
...
### Community 4 - "Script Validacion HAProxy-MinIO DR"
Cohesion: 0.23
Nodes (7): fail(), header(), info(), manual(), pass(), validate_haproxy_minio_dr.sh script, warn()

### Community 5 - "Script Validacion HAProxy-MinIO Principal"
Cohesion: 0.23
Nodes (7): fail(), header(), info(), manual(), pass(), validate_haproxy_minio_principal.sh script, warn()

### Community 6 - "Arquitectura PostgreSQL HA"
Cohesion: 0.30
...
### Community 7 - "Mapa de Integraciones (Flink/Kafka/Iceberg/MinIO)"
Cohesion: 0.32
...
### Community 8 - "Referencias del Skill Graphify"
Cohesion: 0.20
...
### Community 26 - "Guias de Preparacion Integracion Kafka-Flink-MinIO"
Cohesion: 0.67
...
## Knowledge Gaps
- **34 isolated node(s):** `validacion-node-exporter.sh script`, `.claude/CLAUDE.md — graphify skill pointer`, `graphify reference: add-watch`, `graphify reference: exports`, `graphify reference: GitHub clone and cross-repo merge` (+29 more)
...
- **What is the exact relationship between `flink-s3-fs-hadoop / flink-s3-fs-presto plugin` and `iceberg-flink-runtime JAR (integración Flink↔Iceberg/Gravitino, fuera de alcance)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Informe de validación Flink DR (HTML)` connect `Fallas Detectadas en Validacion Flink DR` to `Stack de Observabilidad y Kafka DR/Principal`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Kafka DR cluster (dr-kaf-1 / pbigd-kaf0X-cont)` connect `Stack de Observabilidad y Kafka DR/Principal` to `Fallas Detectadas en Validacion Flink DR`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `validate_flink_principal.sh run — pbigd-plat-apps01 (JM Principal)` connect `Fallas Detectadas en Validacion Flink DR` to `Stack de Observabilidad y Kafka DR/Principal`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `validacion-node-exporter.sh script`, `.claude/CLAUDE.md — graphify skill pointer`, `graphify reference: add-watch` to the rest of the system?**
